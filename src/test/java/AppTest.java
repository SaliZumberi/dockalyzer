...
import services.CommitProcessor;
...
public class AppTest {
    ...
    public void getRawDockerfilesFromProjectWithRepisitory() throws Exception {
        ...
        //act
        app.setRepoFolderName(App.LOCAL_REPO_FOLDER + String.valueOf( app.getProject().getRepositoryPath()));
        app.setRepoFolderNameDotGit(app.getRepoFolderName() + "/.git");
